...
line = (
    ...
    "64062862089986280348253421170679 82148086513282306647093844609550582"
    "23172535940812848111745028410270193852110555964462294895493038196 "
    "104683731294243150"
).split()
...
for _ in range(n):
    ...
    # base cases
    bcs = {"A": (len(line[0]), line[0]), "B": (len(line[1]), line[1])}
    d = int(line[2])
    memo = {0: "A", 1: "B"}
